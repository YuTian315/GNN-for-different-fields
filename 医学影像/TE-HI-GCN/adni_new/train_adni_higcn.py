...
import torch
import random
from hinets.model_higcn_ADNI import MyHIgcn as HiGCN
...
def train():
    ...
    for fold in range(10):
        ...
        model = HiGCN(in_dim=5, hidden_dim=5, graph_adj=graph_adj, num=fold, thr=0)

        # model.load_state_dict(
        #     torch.load('ASD_aal/higcn_' + str(fold+1) + '_0.' + str(thr) + '.pt'))
