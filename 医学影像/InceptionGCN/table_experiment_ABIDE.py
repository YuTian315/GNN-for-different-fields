from train_ABIDE import *


def table_experiment_ABIDE(adj_type, learning_rate, is_skip_connection):
...
def file_writer(avg_table, std_table, table_type, adj_type, is_skip_connection, locality_upper_bound):
    ...
    with open('ABIDE_Acc_avg_std_{}_skip_{}.csv'.format(adj_type, is_skip_connection), mode='a') as csv_file:
