...
num_subjects = 949  # Number of subjects
...
time_series = Reader.get_timeseries(subject_IDs, 'tt')

# Compute and save connectivity matrices
for i in range(len(subject_IDs)):
        Reader.subject_connectivity(time_series[i], subject_IDs[i], 'tt', 'correlation')
